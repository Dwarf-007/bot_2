...
def test_campaign_state_transition_models_have_no_runtime_coupling():
    text = Path("services/compendium/campaign_state_transition_models.py").read_text(encoding="utf-8")
