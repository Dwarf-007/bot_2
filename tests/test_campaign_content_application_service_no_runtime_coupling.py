...
def test_campaign_content_application_service_has_no_avrae_or_discord_runtime_coupling():
    text = Path("services/compendium/campaign_content_application_service.py").read_text(encoding="utf-8")
...
def test_campaign_content_application_service_uses_turn_output_contract():
    text = Path("services/compendium/campaign_content_application_service.py").read_text(encoding="utf-8")
