...
def test_campaign_transition_approval_policy_has_no_runtime_coupling():
    text = Path("services/compendium/campaign_transition_approval_policy.py").read_text(encoding="utf-8")
